...
CSRC	= io_png.c balance_lib.c colorspace_lib.c \
		balance_rgb.c balance_hsl.c balance_hsv.c \
...
BIN	= balance_rgb balance_hsl balance_hsv balance_hsi balance_hsi_bounded
...
balance_hsl	: io_png.o balance_lib.o colorspace_lib.o balance_hsl.o
	$(CC) $^ $(LDFLAGS) -o $@
balance_hsv	: io_png.o balance_lib.o colorspace_lib.o balance_hsv.o
	$(CC) $^ $(LDFLAGS) -o $@
