 ...
 * it under the terms of the simplified BSD License. ou should have
 * received a copy of this license along this program. If not, see
 * <http://www.opensource.org/licenses/bsd-license.html>.
 */

/**
 * @file colorspace_lib.c
 * @brief color space conversion routines, derived from Pascal
 * Getreuser's colorspace conversion code:
